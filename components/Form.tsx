...
const Form = ({ type, post, setPost, submitting, handleSubmit }: any) => {
  return <section className="w-full max-w-full flex-start flex-col">
    ...
    <p className="desc text-left max-w-md">
      {type} and share amazing prompts with the world, and let your imgination run with any AI-Powerd platform.
    </p>
    ...
    >
      <label>
        <span className="font-satoshi font-semiblod text-base text-gray-700">
          Your AI Prompt
        </span>
